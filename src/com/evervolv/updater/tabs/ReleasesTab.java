...
public class ReleasesTab extends UpdatesFragment implements OnPreferenceChangeListener {

    private static final String AVAILABLE_UPDATES_CAT = "pref_updates_releases_category_available_updates";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.tab_releases);
        ...
        mUpdateType = Constants.BUILD_TYPE_RELEASE;
        mUpdateAction = Constants.ACTION_UPDATE_CHECK_RELEASE;
