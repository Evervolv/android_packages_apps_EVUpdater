...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.evervolv.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.evervolv.device";
    public static final String PROP_RELEASE_TYPE = "ro.evervolv.releasetype";
