...
package com.evervolv.updater.misc.afiledialog.view;
...
public class FileItem extends LinearLayout {
	...
	private void updateIcon() {
		// Define the icon.
		int icon = R.drawable.daidalos_document_gray;
		if(this.selectable) {
			icon = (this.file != null && file.isDirectory())? R.drawable.daidalos_folder : R.drawable.daidalos_document;
		}
		...
		if(icon != R.drawable.daidalos_document_gray) {
